...
| ----| ---------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|
| 9   | [Palindrome Number](https://leetcode.com/problems/palindrome-number/)|[Arrays](leetcode/palindrome-number/array_hashing), [Two Pointers](leetcode/palindrome-number/two_pointers), [Stack](leetcode/palindrome-number/stack), [Linked List](leetcode/palindrome-number/linked_list), [Math](leetcode/palindrome-number/math_geometry)|[O(log n), O(1)](leetcode/palindrome-number/math_geometry)|
